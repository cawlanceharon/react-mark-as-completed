    ...
    const UsersList = ({users}) => {
        return (users.map((data, i) =>
            <tr key={i}>
                ...
                <td>
                    {!data.status && <Alert variant="danger">Incomplete</Alert>}
                    {data.status && <Alert variant="primary">Completed</Alert>}
                </td>
                <td>
                    ...
                    {!data.status && <Button variant="outline-primary" onClick={e => {handleMarkAsComplete(data)}}>Mark As Completed</Button>}
                </td>
            </tr>
        ));
    };
